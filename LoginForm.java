...
public class LoginForm extends JFrame {
	 ...
	 * Runnable() { public void run() { try { LoginForm frame = new LoginForm();
	...
	public LoginForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				validate = control.login(user.getEmail(), user.getPassword());
				try {
					user.setId(control.getUserID(user));
		...
		btnNewButton_2.setIcon(new ImageIcon("C:\\Users\\Joe\\Desktop\\test_dp\\exit.png"));
		btnNewButton_2.setBounds(661, 0, 23, 23);
